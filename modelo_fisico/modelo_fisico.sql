...
-- -----------------------------------------------------
-- Table `IFBOOKS`.`LIVROS_DA_PUBLICACAO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`LIVROS_DA_PUBLICACAO` (
  `ID_LIVRO` INT NOT NULL,
  `ID_PUBLICACAO` INT NOT NULL,
  INDEX `FK_PUBLICACAO_idx` (`ID_PUBLICACAO` ASC) VISIBLE,
  INDEX `FK_LIVRO_idx` (`ID_LIVRO` ASC) VISIBLE,
  CONSTRAINT `FK_PUBLICACAO`
