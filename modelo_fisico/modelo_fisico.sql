...
-- Table `IFBOOKS`.`FEED`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`FEED` (
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`USUARIO` (
  ...
  INDEX `FK_USUARIO_FEED_idx` (`ID_FEED` ASC) VISIBLE,
  CONSTRAINT `FK_USUARIO_FEED`
    FOREIGN KEY (`ID_FEED`)
    REFERENCES `IFBOOKS`.`FEED` (`ID_FEED`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `IFBOOKS`.`INFORMACAO_PESSOAIS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`INFORMACAO_PESSOAIS` (
  `ID_USUARIO` INT NOT NULL,
  `DATA_NASCIMENTO` DATE NULL,
  `NOME` VARCHAR(50) NULL,
  PRIMARY KEY (`ID_USUARIO`),
  INDEX `fk_INFORMACAO_PESSOAIS_USUARIO1_idx` (`ID_USUARIO` ASC) VISIBLE,
  CONSTRAINT `fk_INFORMACAO_PESSOAIS_USUARIO1`
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`ENDERECO` (
  ...
  INDEX `fk_ENDERECO_INFORMACAO_PESSOAIS1_idx` (`ID_INFORMACOES_PESSOAIS` ASC) VISIBLE,
  CONSTRAINT `fk_ENDERECO_INFORMACAO_PESSOAIS1`
    FOREIGN KEY (`ID_INFORMACOES_PESSOAIS`)
    REFERENCES `IFBOOKS`.`INFORMACAO_PESSOAIS` (`ID_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`TELEFONE` (
  ...
  INDEX `FK_INFORMACOES_PESSOAIS_idx` (`ID_INFORMACOES_PESSOAIS` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`PUBLICACOES` (
  `ID_PUBLICACOES` INT NOT NULL AUTO_INCREMENT,
  `ID_FEED` INT NOT NULL,
  PRIMARY KEY (`ID_PUBLICACOES`),
  INDEX `FK_PUBLICACOES_FEED_idx` (`ID_FEED` ASC) VISIBLE,
  CONSTRAINT `FK_PUBLICACOES_FEED`
    FOREIGN KEY (`ID_FEED`)
    REFERENCES `IFBOOKS`.`FEED` (`ID_FEED`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `IFBOOKS`.``
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`` (
  `ID_PUBLICACOES` INT NOT NULL AUTO_INCREMENT,
  `ID_COMENTARIOS` INT NOT NULL,
  PRIMARY KEY (`ID_PUBLICACOES`, `ID_COMENTARIOS`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`COMENTARIOS` (
  ...
  CONSTRAINT `FK_PUBLICACOES`
    ...
    REFERENCES `IFBOOKS`.`PUBLICACOES` (`ID_PUBLICACOES`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`LIVRO_POSSUI_GENERO` (
  ...
  INDEX `FK_GENERO_idx` (`FK_GENERO` ASC) VISIBLE,
  CONSTRAINT `FK_LIVRO`
...
-- -----------------------------------------------------
-- Table `IFBOOKS`.`PEDIDO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`PEDIDO` (
  `ID_PEDIDO` INT NOT NULL AUTO_INCREMENT,
  `VALOR_TOTAL` DOUBLE NOT NULL,
  `FORMA_PAGAMENTO` ENUM('CARTAO_DEBITO', 'CARTAO_CREDITO', 'PIX', 'BOLETO') NULL,
  `ID_CARRINHO` INT NOT NULL,
  PRIMARY KEY (`ID_PEDIDO`),
  INDEX `FK_CARRINHO_idx` (`ID_CARRINHO` ASC) VISIBLE,
  CONSTRAINT `FK_CARRINHO`
    FOREIGN KEY (`ID_CARRINHO`)
    REFERENCES `IFBOOKS`.`CARRINHO` (`ID_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`PEDIDO_APROVADO` (
  ...
  CONSTRAINT `FK_PEDIDO`
    ...
    REFERENCES `IFBOOKS`.`PEDIDO` (`ID_PEDIDO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
