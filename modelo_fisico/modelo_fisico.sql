...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`ENDERECO` (
  ...
  CONSTRAINT `FK_ID_USUARIO_ENDERECO`
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`PUBLICACOES` (
  ...
  CONSTRAINT `FK_ID_USUARIO_PUBLICACOES`
    FOREIGN KEY (`ID_USUARIO`)
    REFERENCES `IFBOOKS`.`USUARIO` (`ID_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`BIBLIOTECA_PESSOAL` (
  ...
  `DATA_FIM` DATE NULL,
  `PROGRESSO` INT NULL,
  `STATUS` ENUM('Lendo', 'Quero ler', 'Relendo', 'Abandonei', 'Lido', 'Emprestei') NOT NULL,
  INDEX `FK_ID_USUARIO_idx` (`ID_USUARIO` ASC) VISIBLE,
  INDEX `FK_ID_LIVRO_idx` (`ID_LIVRO` ASC) VISIBLE,
  CONSTRAINT `FK_ID_USUARIO_BIB_PESSOAL`
    FOREIGN KEY (`ID_USUARIO`)
    REFERENCES `IFBOOKS`.`USUARIO` (`ID_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_ID_LIVRO_BIB_PESSOAL`
    FOREIGN KEY (`ID_LIVRO`)
    REFERENCES `IFBOOKS`.`LIVRO` (`ID_LIVRO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`AVALIACAO` (
  ...
  INDEX `FK_ID_LIVRO_idx` (`ID_LIVRO` ASC) VISIBLE,
  CONSTRAINT `FK_ID_LIVRO_AVALIACAO`
    FOREIGN KEY (`ID_LIVRO`)
    REFERENCES `IFBOOKS`.`LIVRO` (`ID_LIVRO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`LIVRO_POSSUI_EDITORA` (
  ...
  CONSTRAINT `FK_EDITORA`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_ID_LIVRO_EDITORA`
    FOREIGN KEY (`FK_ID_LIVRO`)
    REFERENCES `IFBOOKS`.`LIVRO` (`ID_LIVRO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `IFBOOKS`.`CARRINHO` (
  ...
  CONSTRAINT `FK_ID_LIVRO_CARRINHO`
    FOREIGN KEY (`ID_LIVRO`)
    REFERENCES `IFBOOKS`.`LIVRO` (`ID_LIVRO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_ID_USUARIO_CARRINHO`
    FOREIGN KEY (`ID_USUARIO`)
    REFERENCES `IFBOOKS`.`USUARIO` (`ID_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
